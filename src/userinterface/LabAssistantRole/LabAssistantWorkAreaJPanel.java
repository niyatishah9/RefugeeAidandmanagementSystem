...
public class LabAssistantWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 190, 570, 120));
        ...
        add(assignJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 430, 140, -1));
        ...
        add(processJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 380, 140, -1));
        ...
        add(refreshJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 320, 140, -1));
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 214, 330, -1));

        jPanel1.setBackground(new java.awt.Color(102, 102, 102));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel2.setText("Lab Assistant");
        jPanel1.add(jLabel2);

        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 900, 90));
        ...
        add(logoutJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 100, -1, -1));
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        LabTest requests = (LabTest)workRequestJTable.getValueAt(selectedRow, 0);
        if(!requests.getStatus().equals("Completed")){
            requests.setStatus("Processing");
            dB4OUtil.storeSystem(business);
            ProcessWorkRequestJPanel processWorkRequestJPanel = new ProcessWorkRequestJPanel(userProcessContainer, requests,business);
